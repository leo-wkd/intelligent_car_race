...
//      模块通道    端口          可选范围                          建议
#define UART0_RX_PIN    PTB16       //PTA1、PTA15、PTB16、PTD6          PTA1不要用（与Jtag冲突） 上位机通信
...
#define UART3_RX_PIN    PTB10       //PTB10、PTC16、PTE5     双车通信 
...
#define FTM0_CH4_PIN    PTA7        //PTD4、PTA7            电机用PTD4.5.6.7
...
//      模块通道    端口          可选范围              建议
#define FTM1_CH0_PIN    PTA8        //PTA8、PTA12、PTB0     //正交解码测速
#define FTM1_CH1_PIN    PTA9       //PTA9、PTA13、PTB1

//      模块通道    端口          可选范围              建议
#define FTM2_CH0_PIN    PTA10       //PTA10、PTB18         //正交解码测速
#define FTM2_CH1_PIN    PTA11       //PTA11、PTB19


#ifdef  MK60F15                 //ALT6       ALT3        ALT4        FX 才有FTM3模块

#define FTM3_CH0_PIN    PTE5        //PTE5                   PTD0    //舵机PTE6
...
#define FTM1_QDPHB_PIN  PTA9       //PTA9、PTA13、PTB1   //编码器测速
